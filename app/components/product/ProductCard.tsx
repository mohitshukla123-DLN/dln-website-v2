      ...
      <div className="bg-white p-3 sm:p-5">
        ...
        <div className="mt-3 flex w-full flex-row gap-2 sm:mt-4 sm:gap-3">
          <Link
            ...
            >
              <Button className="flex w-full items-center justify-center whitespace-nowrap px-1 py-2 text-center text-[9px] font-semibold sm:px-4 sm:py-3 sm:text-base">
                Details
              </Button>
            </Link>
          ...
          >
            <Button className="flex w-full items-center justify-center gap-1 whitespace-nowrap px-1 py-2 text-center text-[8px] font-semibold sm:gap-2 sm:px-4 sm:py-3 sm:text-base">
              ...
              <span className="text-[9px] sm:text-sm">Enquiry</span>
            </Button>
          </a>
        </div>
      </div>
