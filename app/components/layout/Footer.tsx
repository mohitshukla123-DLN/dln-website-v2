  ...
  return (
    <footer
      ...
      <Container className="py-4 sm:py-5">
        <div className="flex flex-col items-center text-center">
          ...
          {phone && (
            <a
              ...
              className="mt-2 inline-flex items-center gap-2 rounded-full bg-amber-500/15 px-3 py-1.5 text-sm font-semibold text-amber-300 transition hover:bg-amber-500/25 hover:text-amber-200 sm:text-sm"
            >
        ...
        <div className="mt-3 border-t border-white/10 pt-3 text-center text-xs text-gray-500">
          {copyrightText ||
