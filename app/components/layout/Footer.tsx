  ...
  return (
    <footer
      ...
      <Container className="py-7 sm:py-9">
        <div className="flex flex-col items-center text-center">
          ...
          {phone && (
            <a
              ...
              className="mt-2 text-sm text-gray-300 transition hover:text-white sm:text-base"
            >
              {phone}
            </a>
          )}
          ...
          <div className="mt-4 flex items-center justify-center gap-3">
            {instagram && (
              <a href={instagram} target="_blank" rel="noreferrer" aria-label="Instagram"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[#E4405F] text-white shadow-sm transition hover:scale-105">
            ...
            {facebook && (
              <a href={facebook} target="_blank" rel="noreferrer" aria-label="Facebook"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[#1877F2] text-white shadow-sm transition hover:scale-105">
                <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
            ...
            {youtube && (
              <a href={youtube} target="_blank" rel="noreferrer" aria-label="YouTube"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[#FF0000] text-white shadow-sm transition hover:scale-105">
                <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
            ...
            {pinterest && (
              <a href={pinterest} target="_blank" rel="noreferrer" aria-label="Pinterest"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[#E60023] text-white shadow-sm transition hover:scale-105">
                <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
            ...
            {linkedin && (
              <a href={linkedin} target="_blank" rel="noreferrer" aria-label="LinkedIn"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0A66C2] text-white shadow-sm transition hover:scale-105">
                <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
        ...
        <div className="mt-6 border-t border-white/10 pt-5 text-center text-xs text-gray-500 sm:mt-7">
          {copyrightText ||
